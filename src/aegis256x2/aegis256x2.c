...
int
aegis256x2_state_decrypt_update(aegis256x2_state *st_, uint8_t *m, size_t mlen_max, size_t *written,
...
int
aegis256x2_state_decrypt_final(aegis256x2_state *st_, uint8_t *m, size_t mlen_max, size_t *written,
