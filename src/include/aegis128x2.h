 ...
 * Return 0 on success, -1 on failure.
 */
int aegis128x2_state_decrypt_update(aegis128x2_state *st_, uint8_t *m, size_t mlen_max,
 ...
 */
int aegis128x2_state_decrypt_final(aegis128x2_state *st_, uint8_t *m, size_t mlen_max,
