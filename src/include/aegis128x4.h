 ...
 *
 * DEPRECATED: use aegis128x4_stream_xor() in new code. Its output is different, so only keep this
 * for existing data.
 *
 ...
 *
 * DEPRECATED: use aegis128x4_stream_xor() in new code. Only keep this to decrypt data from
 * aegis128x4_encrypt_unauthenticated().
 *
 * WARNING: this is an insecure mode of operation, provided for compatibility with specific
 * protocols that bring their own authentication scheme.
 *
