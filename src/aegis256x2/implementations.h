...
typedef struct aegis256x2_implementation {
    ...
    int (*state_decrypt_update)(aegis256x2_state *st_, uint8_t *m, size_t mlen_max, size_t *written,
                                const uint8_t *c, size_t clen);
    int (*state_decrypt_final)(aegis256x2_state *st_, uint8_t *m, size_t mlen_max, size_t *written,
