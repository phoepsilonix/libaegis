 ...
 * Return 0 on success, -1 on failure.
 */
int aegis256x4_state_decrypt_update(aegis256x4_state *st_, uint8_t *m, size_t mlen_max,
 ...
 */
int aegis256x4_state_decrypt_final(aegis256x4_state *st_, uint8_t *m, size_t mlen_max,
